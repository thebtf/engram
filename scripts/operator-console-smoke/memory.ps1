...
Assert-Contains $memory "memory.detail.actions.hideNoise" "design-contract hide-noise action"
Assert-Contains $memory "memory.detail.actions.promote" "design-contract lifecycle action"
