...
- **SC-05**: Under the documented first-release acceptance profile, 95% of observed saved-change batches become visible to their authorized client within two seconds, or the response visibly reports that currentness is still catching up, partial, offline, or unavailable.
