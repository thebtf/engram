...
| FR-019, FR-020, SC-005 boundary | T005, T011–T013, T015 | `internal/operability/baseline_metrics.go`; `internal/worker/handlers_stats.go`; `internal/worker/handlers_data.go`; `scripts/recovery/**`; `internal/recoveryreceipt/ar1_baseline.go` |
