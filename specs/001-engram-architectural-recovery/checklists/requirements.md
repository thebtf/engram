...
- [x] Scope boundaries explicitly exclude working-surface redesign, graph products, broad temporal
      interfaces, SaaS expansion, new cognitive families, and unrelated modernization.
...
- [x] The specification does not authorize implementation, database mutation, deployment, or
