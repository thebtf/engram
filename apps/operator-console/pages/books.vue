...
<style scoped>
.retirement-page { display: grid; gap: 14px; max-width: 720px; }
header, section { padding: 18px; border: 1px solid var(--border); border-radius: var(--r-md); background: var(--surface); }
