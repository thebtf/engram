...
| Secrets accidentally committed in changed lines | gitleaks 8.30.0 scans added diff lines plus untracked/ignored batch artifacts with full redaction | 141,552 UTF-8 bytes scanned from batch base; no leaks found | PASS |
