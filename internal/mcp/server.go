		...
		},
		{
			...
			InputSchema: map[string]any{
				...
				"properties": map[string]any{
					...
					"scope":   map[string]any{"type": "string", "enum": []string{"project"}, "default": "project", "description": "Credential scope. Only project scope is supported."},
					"project": map[string]any{"type": "string", "description": "Project name (required for store, get, and delete; list returns that project's credentials)"},
				},
			},
		},
		{
