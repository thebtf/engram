...
const docTemplate = `{
        ...
        "/api/rules": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "boolean",
                        "description": "Return all active rules across scopes",
                        "name": "all",
                        "in": "query"
                    },
                    {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_worker.behavioralRuleRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        "github_com_thebtf_engram_internal_embedding.EmbedError": {
            "type": "object",
            "properties": {
                "at": {
                    "type": "string"
        ...
        "github_com_thebtf_engram_pkg_models.Memory": {
            ...
            "properties": {
                ...
                "owner_principal": {
                    "description": "OwnerPrincipal is server-derived from the authenticated identity, never\nfrom caller-supplied payload fields.",
                    "type": "string"
                },
        ...
        "internal_worker.embeddingTelemetry": {
            ...
            "properties": {
                ...
                "embedding_coverage": {
                    "description": "fraction 0..1; 0 when no active memories",
                    "type": "number"
                },
                "last_chunk_at": {
                    "type": "string"
                ...
                "last_embed_error": {
                    "$ref": "#/definitions/github_com_thebtf_engram_internal_embedding.EmbedError"
                },
        ...
        "internal_worker.outcomeTelemetry": {
            "type": "object",
            "properties": {
                "by_outcome": {
                    "type": "object",
        ...
        "internal_worker.projectCitationRate": {
            "type": "object",
            "properties": {
                "citation_rate": {
                    "type": "number"
        ...
        "internal_worker.vnextStatsResponse": {
            ...
            "properties": {
                ...
                "embedding": {
                    "$ref": "#/definitions/internal_worker.embeddingTelemetry"
                },
                "generated_at": {
                    "type": "string"
                },
                ...
                "project_citation_rates": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_worker.projectCitationRate"
                    }
                },
                "uncited_count": {
                    "type": "integer"
